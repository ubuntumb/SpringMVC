...
<html>
<head>
<spring:message code="default.create.label" var="list"
	arguments="Contacto" />
...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div id="create-contacto" role="main">
				...
				<div class="panel panel-default">
					...
					<spring:url value="/contacto/save" var="saveUrl"  />
					<form:form modelAttribute="contacto" action="${saveUrl}" cssClass="form-horizontal">
						<fieldset class="form">
